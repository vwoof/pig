...
<body align="center">
    <div class="all" style="width: 95%; text-align: left; margin-top: 10px; margin-left: 10px;
        margin-right: 10px;">
        <h3>
            夺宝规则</h3>
        <p>
            1、每次微信充值都会生成一个唯一交易单号，该单号公平、公正、公开，仅由微信平台生成。
        </p>
        <p>
            2、尾数夺宝采集微信充值交易单号的尾数作为夺宝依据，尾数 5 ~ 9 为大、 0 ~ 4 为小，0、2、4、6、8为双，1、3、5、7、9为单。
        </p>
        <p>
            3、猜大猜小后请充值 0.1 元或提现1元，充值后微信交易单号立刻显示。
        </p>
        <p>
            4、每手 10 元，每手 1 元手续费，每次夺宝最小 1 手，最大 50 手。
        </p>
