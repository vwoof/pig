...
class PublicController extends AdminbaseController {
    ...
    */
    ...
    public function do_channel_login() {
        ...
        if(false) {//!sp_check_verify_code()){
            ...
            $channel = M('channels')->where('admin_user_id=' . $result['id'])->find();
            
            if ($channel == null)
                $this->error('请输入正确的渠道帐号');
