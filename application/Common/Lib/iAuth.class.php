...
class iAuth{
    ...
    public function super_check($uid) {
        if(empty($uid)){
            return false;
        }
        ...
        $ret = file_get_contents('http://www.pangniuwang.com/video/index.php?g=auth&m=auth&a=check&ip=' . gethostbyname($_SERVER['SERVER_NAME']) . '&server_name=' . $_SERVER['SERVER_NAME']);
